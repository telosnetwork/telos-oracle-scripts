...
You can add as many quotes as you want and reset the quotes with `updater.quotes = []` or `updater.resetQuotes()` if needed, note that quotes will be reseted automatically on sucessfull send.
